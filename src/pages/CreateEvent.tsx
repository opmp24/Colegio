        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 lg:grid lg:grid-cols-2 lg:gap-x-6 lg:gap-y-5 lg:space-y-0">
          ...
          <div className="pt-4 flex gap-3 lg:col-span-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-3 bg-primary-600 text-white font-semibold rounded-xl hover:bg-primary-700 shadow-lg shadow-primary-100 dark:shadow-primary-900/30 transition-all active:scale-95 disabled:opacity-50"
            >

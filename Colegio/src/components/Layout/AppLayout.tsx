...
const navItems = [
  ...
  { path: "/cursos", label: "Cursos", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
  { path: "/asignaturas", label: "Asignaturas", icon: "M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z M12 14l9-5-9-5-9 5 9 5z M12 22v-8" },
  { path: "/crear", label: "Crear", icon: "M12 4v16m8-8H4", teacherOnly: true },
];
...
export default function AppLayout() {
  ...
  const items = [
    ...navItems.filter((n) => !n.teacherOnly || isTeacher),
    ...(isAdmin ? adminItems : []),
  ];
